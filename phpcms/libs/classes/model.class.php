...
class model {
	...
	public function __construct() {
		...
		$db_config=$this->db_config[$this->db_setting];
	 ...
	 * @return bool
	 */
	final public function muti_query(array $sqls=array()) {
	 ...
	 * @return array
	 */
	final public function muti_results() {
		return $this->db->get_multi_result();
	}
	 ...
	 * @return boolean
	 */
	final public function insertArray($data, $return_insert_id = false, $replace = false) {
		return $this->db->insertArray($data, $this->table_name, $return_insert_id, $replace);
	}
...
// 	    while(($r=$this->db->fetch_next(MYSQL_ASSOC))!=FALSE)
// 	    {
// 	        $data[]=$r; 
// 	    }
// 	    if($this->db->last_result)
// 	    {
// 	        $data=$this->db->last_result->fetch_all(MYSQLI_ASSOC);
// 	        $this->db->last_result->free_result();
// 	        $this->db->last_result=null;
// 	    }
		return $data;
	}
